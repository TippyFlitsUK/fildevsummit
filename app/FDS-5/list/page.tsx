...
import { FDS_5_LIST_CONTENT } from '@root/content/fildevsummit/filecoin-dev-bangkok-2024';

export async function generateMetadata({ params, searchParams }) {
  const title = 'FIL Dev Summit 2024: Bangkok';
  const description =
...
export default async function Page(props) {
  const blocks = FDS_5_LIST_CONTENT;
