...
import { FDS_6_LIST_CONTENT } from '@root/content/fildevsummit/filecoin-dev-toronto-2025';

export async function generateMetadata({ params, searchParams }) {
  const title = 'FIL Dev Summit 2025: Toronto';
  const description =
...
export default async function Page(props) {
  const blocks = FDS_6_LIST_CONTENT;
